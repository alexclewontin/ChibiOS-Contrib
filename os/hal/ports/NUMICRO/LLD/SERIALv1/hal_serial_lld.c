...
#define NUC123_UART0_IRQ_HANDLER Vector70
#define NUC123_UART1_IRQ_HANDLER Vector74
...
OSAL_IRQ_HANDLER(NUC123_UART0_IRQ_HANDLER)
{
  OSAL_IRQ_PROLOGUE();
...
OSAL_IRQ_HANDLER(NUC123_UART1_IRQ_HANDLER)
{
  OSAL_IRQ_PROLOGUE();
